...
public class LogAspect {
    ...
    @Pointcut(
            "execution(* " +//方法返回值：所有
                    "club.looli.onlineexam.admin.controller.*.logout" +//哪个包下的哪个类中的哪个方法
                    "(..))"//方法参数：任意
    )
    public void pc1(){
    ...
    @Pointcut(
            "execution(* " +//方法返回值：所有
                    "club.looli.onlineexam.admin.controller.*.loginA*" +//哪个包下的哪个类中的哪个方法
                    "(..))"//方法参数：任意
    )
    public void pc2(){
    ...
    @Pointcut(
            "execution(* " +//方法返回值：所有
                    "club.looli.onlineexam.admin.controller.*.editPasswordAct" +//哪个包下的哪个类中的哪个方法
                    "(..))"//方法参数：任意
    )
    public void pc3(){
