...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>试题科目:</label>
            <input id="search-subject" class="easyui-combobox" name="subjectId" panelHeight="auto" style="width:120px;" data-options="
...
<#--                <option value="-1">全部</option>-->
<#--&lt;#&ndash;                <c:forEach items="${subjectList}" var="subject">&ndash;&gt;-->
    ...
    <form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input name="subjectId" class="easyui-combobox" name="subjectId" panelHeight="auto" style="width:268px;" data-options="
